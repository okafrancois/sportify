    ...
    return (
        <div className={"home-view container"}>
            <div className="greets">
                <h1 className={"greets__title"}>Bonjour <span className={"username"}>{userDatas?.userInfos.firstName}</span></h1>
                ...
                <div className="datas__key key-data">
                    <div className="key-data__list">
                        <DataCard
                            ...
                            value={`${userDatas?.keyData?.calorieCount}kcal`}
                            name={"Calories"}
                            className={"color-red"}
                        />
                        <DataCard
                            ...
                            value={`${userDatas?.keyData?.proteinCount}g`}
                            name={"Protéines"}
                        ...
                        <DataCard
                            ...
                            value={`${userDatas?.keyData?.carbohydrateCount}g`}
                            name={"Glucides"}
                        ...
                        <DataCard
                            ...
                            value={`${userDatas?.keyData?.lipidCount}g`}
                            name={"Glucides"}
